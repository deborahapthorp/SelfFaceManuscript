...
```{r make raincloud plots recognition}
...
# scale_color_manual(values = c(inverted_col, upright_col))
...
RecognitionTimes_ANOVA <- aov_ez("Participant", "Mean_time", Mean_Frames_long, within=c("Orientation", "Familiarity"),
                            factorize = FALSE, covariate = "Age_c") # Do ANOVA

EM_Means_RecognitionTimes <- emmeans (RecognitionTimes_ANOVA, ~ Orientation|Familiarity) # Get EM Means
